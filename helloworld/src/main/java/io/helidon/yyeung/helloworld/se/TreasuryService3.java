...
public class TreasuryService3 implements Service {
    ...
    TreasuryService3(Config config) {
        this.greeting = config.get("app.greeting").asString().orElse("Ciao");
	try {
		InputStream in = this.getClass().getClassLoader().getResourceAsStream("treasury3.txt");
		buffer = IOUtils.toString(in);
		in.close();
	} catch (Throwable t) {
		t.printStackTrace();
	}
